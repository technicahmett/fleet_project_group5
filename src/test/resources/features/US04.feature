...
Feature: Users can access the Vehicle Contracts page
  ...
  Scenario: Verify access to Vehicle Contracts page as Store Manager
    ...
    Then the page title is "All - Vehicle Contract - Entities - System - Car - Entities - System"
    Then the URL is "All - Vehicle Contract - Entities - System - Car - Entities - System"
